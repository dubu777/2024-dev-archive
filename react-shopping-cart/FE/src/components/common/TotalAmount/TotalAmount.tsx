  ...
  return (
    <TotalAmountContainer ref={totalAmountRef}>
      ...
      <TotalAmountWrapper>
        ...
        <Text type="subTitle">{numberCommas(calculateTotalAmount())}원</Text>
      </TotalAmountWrapper>
      <TotalAmountWrapper>
        <Text type="subTitle">배송비</Text>
        <Text type="subTitle">{numberCommas(calculateShippingFee())}원</Text>
      </TotalAmountWrapper>
      {type === "order" && (
        <TotalAmountWrapper>
          <Text type="subTitle">쿠폰 할인 금액</Text>
          <Text type="subTitle" color="red">- {numberCommas(calculateTotalDiscount())}원</Text>
        </TotalAmountWrapper>
      )}
      <Divider size="small" $color="dark" />
      <TotalAmountWrapper>
        <Text type="subTitle">총 결제 금액</Text>
        <Text type="subTitle" color="red">{numberCommas(calculateFinalAmountWithDiscount())}원</Text>
      </TotalAmountWrapper>
